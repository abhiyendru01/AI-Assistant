    ...
    <div className="w-full min-h-screen flex items-center justify-center bg-cover bg-center px-4" style={{ backgroundImage: `url(${bg})` }}>
      ...
      >
        <h1 className="text-[28px] font-bold text-center mb-4">
          Welcome to <span className="text-blue-500">Virtual Assistant</span>
        </h1>
        ...
        <div className="relative w-full h-[56px]">
          ...
          />
          <div className="absolute right-4 top-1/2 transform -translate-y-1/2 cursor-pointer text-xl text-gray-300 hover:text-blue-500"
